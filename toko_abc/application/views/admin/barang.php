            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid">
                        <button class="btn btn-sm btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#tambah_barang">Tambah Barang</button>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo anchor('admin/data_barang/edit/' .$brg->no, '<div class="btn btn-success btn-sm">Edit</div>') ?></td>
                                <td><?php echo anchor('admin/data_barang/hapus/' .$brg->no, '<div class="btn btn-success btn-sm">Hapus</div>')?></td>
                            </tr>
