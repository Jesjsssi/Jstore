                ...
                <main>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="no" class="form-control" value="<?php echo $brg->no ?>">
                            <input type="text" name="nama_barang" class="form-control" value="<?php echo $brg->nama_barang ?>">
                        </div>
                        <div class="form-group">
                            <label for="">Harga Barang</label>
                            <input type="text" name="harga_barang" class="form-control" value="<?php echo $brg->harga_barang ?>">                         
                        </div>
                        <div class="form-group">
